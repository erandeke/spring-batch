...
@Configuration
@EnableBatchProcessing //must annotation to know spring boot about job launcher
public class SpringBatchConfig {
	...
	public LineMapper<User> lineMapper() {
		...
		demLineTokenizer.setNames(new String[] {"user_indentity","user_code","user_department","user_pay_scale"});
